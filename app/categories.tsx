...
const ICONS: (keyof typeof Ionicons.glyphMap)[] = [
  'star-outline', 'heart-outline', 'airplane-outline', 'fitness-outline', 
  'game-controller-outline', 'book-outline', 'musical-notes-outline', 'cafe-outline'
];
  ...
  return (
    <View style={[styles.safeArea, { paddingTop: Platform.OS === 'android' ? insets.top : 20 }]}>
      ...
      <View style={styles.header}>
        {view === 'create' ? (
          <TouchableOpacity onPress={() => setView('list')} style={styles.closeButton}>
            ...
            {ICONS.map((icon) => (
              ...
              >
                <Ionicons 
                  name={icon} 
                  size={24} 
                  color={selectedIcon === icon ? Colors.text : Colors.textSecondary} 
                />
              </TouchableOpacity>
            ))}
          </View>
